    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-destructive">{refundedCount}</div>
          </CardContent>
        </Card>
      </div>
      ...
      <Dialog open={detailsDialog.open} onOpenChange={(open) => setDetailsDialog({ open, transaction: open ? detailsDialog.transaction : null })}>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4 p-4 bg-muted rounded-lg">
                <div>
                  ...
                  <p className="font-mono font-semibold">{detailsDialog.transaction.id}</p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">Date & Time</p>
                  <p className="font-semibold">{formatDate(detailsDialog.transaction.date)}</p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">Cashier</p>
                  <p className="font-semibold">{detailsDialog.transaction.cashier}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <Badge variant={getStatusColor(detailsDialog.transaction.status)}>
                          ...
                          <div className="flex justify-between items-start">
                            <div className="flex-1">
                              ...
                              <div className="flex gap-2 mt-1">
                                ...
                                <Badge variant="outline" className="text-xs">{item.temperature}</Badge>
